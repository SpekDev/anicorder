...
class Anicorder(App):
	...
	def compose(self) -> ComposeResult:
		...
		yield Static(
			"""
         Tip: In areas where vim binds are not allowed like in Input fields,Press Tab
         to cycle to the next option and SHIFT+Tab to go to the previous option!
         """,
	...
	def action_connect_db(self):
		if self.conn is None:
			try:
				...
				self.screen.query_one("#home_db", Button).disabled = True
